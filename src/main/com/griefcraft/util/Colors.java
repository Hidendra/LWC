...
public class Colors {
	...
	static {
		...
		localeColors.put("%2", "\u00A72");
		localeColors.put("%3", "\u00A73");
		localeColors.put("%4", "\u00A74");
		localeColors.put("%5", "\u00A75");
		localeColors.put("%6", "\u00A76");
		localeColors.put("%7", "\u00A77");
		localeColors.put("%8", "\u00A78");
		localeColors.put("%9", "\u00A79");
		localeColors.put("%a", "\u00A7a");
		localeColors.put("%b", "\u00A7b");
		localeColors.put("%c", "\u00A7c");
		localeColors.put("%d", "\u00A7d");
