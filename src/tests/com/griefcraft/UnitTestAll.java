...
/**
 * Run tests using JUnit. Runs a minecraft server to virtualize a real server.
 * MC server that is run is ran on a random port and is only up until tests are completed
 */
public class UnitTestAll {
	...
	public void testConnection() {
		assertTrue(PhysDB.isConnected());
		assertTrue(MemDB.isConnected());
	}
