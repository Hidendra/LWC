	...
	public static void bootstrap() {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(final Thread t, final Throwable e) {
				Bootstrap.uncaughtExceptionLog.logp(Level.SEVERE, "EXCEPTION", "", "Unhandled exception in thread " + t.getName() + ": ", e);
			}
		});

		System.setErr(new PrintStream(new LoggingOutputStream(Bootstrap.errLog, Level.SEVERE), true));
	}
}
